...
- (void)viewDidLoad
{
    ...
    else
    {
        ...
        else
        {
            ...
            [_addToWardrobeButton setTitle: (([[self parentViewController] isKindOfClass:[WardrobeContentViewController class]]) ? NSLocalizedString(@"_MOVETOWARDROBE_", nil) : NSLocalizedString(@"_ADDTOWARDROBE_", nil) ) forState:UIControlStateNormal];
