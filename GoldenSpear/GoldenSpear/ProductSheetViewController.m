...
//             }];
        ...
        case FINISHED_STYLESSEARCH_WITH_RESULTS:
        {
            ...
            if (searchQuery.numresults > 0)
            {
                ...
                // Paramters for next VC (ResultsViewController)
                NSArray * parametersForNextVC = [NSArray arrayWithObjects: searchQuery, foundResults, foundResultsGroups, _shownGSBaseElement, nil];
        ...
        else
        {
            ...
            if(!(selectedResult.fashionistaPostId == nil))
            {
                if(!([selectedResult.fashionistaPostId isEqualToString:@""]))
                {
                    ...
                    NSArray * requestParameters = [[NSArray alloc] initWithObjects:selectedResult.fashionistaPostId, nil];
