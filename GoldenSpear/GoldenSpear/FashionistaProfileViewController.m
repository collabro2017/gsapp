...
- (BOOL) doesCurrentUserWardrobesContainItemWithId:(NSString *)itemId
{
...
- (void)onTapView:(UIButton *)sender
{
    ...
    if(!(_selectedPostId == nil))
    {
        if(!([_selectedPostId isEqualToString:@""]))
        {
            ...
            NSArray * requestParameters = [[NSArray alloc] initWithObjects:_selectedPostId, nil];
...
- (IBAction)onTapEditProfile:(id)sender {
    if (!editMode) {
        ...
        self.editProfileImageButton.hidden = NO;
        ...
        self.editProfileImageButton.hidden = YES;
...
- (void)getPostFromGSServer:(FashionistaPost*)thePost{
    if(!([thePost.idFashionistaPost isEqualToString:@""]))
    {
        ...
        NSArray * requestParameters = [[NSArray alloc] initWithObjects:thePost.idFashionistaPost, nil];
...
- (NSArray *)getSimplePostDataAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSArray * cellContent = [NSArray arrayWithObjects: postInfo, [NSNumber numberWithBool:bShowHanger], [NSNumber numberWithBool:[self doesCurrentUserWardrobesContainItemWithId:tmpPost]], nil];
