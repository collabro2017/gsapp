    ...
    switch (connection) {
        ...
        case GET_FULL_POST:
        {
            ...
            if (loadingUser) {
                ...
                parametersForNextVC = [NSArray arrayWithObjects: [NSNumber numberWithBool:YES], selectedSpecificPost, postContent, resultComments, [NSNumber numberWithBool:NO], postLikesNumber, postUser, self.currentSearchQuery, nil];
