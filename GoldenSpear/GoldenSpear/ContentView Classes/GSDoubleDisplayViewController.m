...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.section == 0) {
        return [postHeight floatValue] + 151;
    }
    if (indexPath.section % 3 == 2) {
        NSInteger height = [postHeight floatValue] + 200;
        return [postHeight floatValue] + 200;
    }
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [self.delegate doubleDisplay:self selectItemAtIndexPath:reversedPath];
}
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [self.delegate doubleDisplay:self selectItemAtIndexPath:indexPath];
}
...
- (void)detailTappedForQuickView:(GSQuickViewViewController*)vC{
    [self dismissControllerModal];
    [self.delegate doubleDisplay:self selectItemAtIndexPath:vC.itemIndexPath];
}
...
- (void)searchForKeywords:(NSArray*)keywordsArray{
